...
1.1. The Scene View 4

1.2. Scene View Navigation 4
...
1.4. The Hierarchy Window 5

1.5. The Inspector Window 6

1.6. The Project Window 7

2\. GameObjects, Components, Prefabs 7
...
3\. Create Game Objects and Basic Transformations: Quick Tutorial 8

3.1. Parenting 8

3.2. GameObjects 9

3.2.1. Creating new GameObjects 9

3.2.2. Creating child GameObjects 9

3.2.3. Creating parent GameObjects 10

3.2.4. Duplicating GameObjects 10

3.2.5. Task: 10

3.3. Make a new Material 11

4\. Events in Unity 13

4.1. Event Functions 13

4.2. Create a C# script for keyboard interaction 13

4.3. MonoBehaviour: 15

4.3.1. Start and Update 15

4.3.2. Declare a variable 15

4.3.3. Add an event in an “if” statement 16

4.3.4. Add an action 16

5\. Download animated characters 17

5.1. Import Package in your Unity File 17

5.2. Make a Plane 18

5.3. Import a character 19

5.4. Click on Play! 19

5.5. Regular Update Events 20

6\. ARCore 20

6.1. Supported devices 21

6.2. How does ARCore work? 21

7\. AR Foundation 21

8\. Start working on the AR App 22

8.1. Configure an AR session and add AR Foundation components 22

8.2. Detect planes in the real world 24

8.2.1. Add an ARPlane Manager Component and place an AR Plane Prefab 24

9\. Build the AR App to test the AR Plane detection 28

10\. Import a file from Rhino 29

10.1. Export file from Rhino 29

10.2. Import file in Unity 32

10.3. Create Prefab with imported Model 34

11\. Instantiate object 35

11.1. Import the Instantiator Script 35

12\. Overview of the code 37

13\. Build App 39

14\. Debugging Session 39
